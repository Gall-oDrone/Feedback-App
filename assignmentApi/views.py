...
from .models import Assignment, AssignmentChoices, GradedAssignment
from .serializers import AssignmentSerializer, AssignmentChoicesSerializer, GradedAssignmentSerializer
...
class AssignmentChoicesViewSet(viewsets.ModelViewSet):
    serializer_class = AssignmentChoicesSerializer
    queryset = AssignmentChoices.objects.all()
