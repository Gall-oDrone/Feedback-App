...
# ************* REQUEST VALUES *************
method = 'GET'
#For Incentives "service" should be AGCODService instead of "ec2"
service = 'ec2'
#For Incentives "host" should be agcod-v2-gamma.amazon.com instead of 'ec2.amazonaws.com'
...
# ¿x-amz-credential == string_to_sign?
