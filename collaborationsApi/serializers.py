...
class CollaborationSerializer(serializers.ModelSerializer):
    ...
    def update_likes(self, request):
        ...
        print(data)
        article = Collaboration(pk='id')
        article.likes_count += data
        article.save()
        return article
    
    def add_star(self, request):
        add_star = Collaboration.rating_count + 1
    
    def add_comment(self, request):
        add_comment = Collaboration.comment_count + 1

    def count_likes(self, request):
        add_like = Collaboration \
            .objects \
            .values("tags__tag") \
    ...
    def stars_count(self, request):
        ...
        # article = Collaboration.objects.all()
        ...
        # print("Collaboration Obj all")
        # print(article)
        # print(Collaboration.objects.get(id="13"))
        # ar2 = Collaboration.objects.get(id="13")
    ...
    #     article = Collaboration()
        ...
        # return graded_asnt
# class ProfileCollaborationListSerializer(serializers.ListSerializer):
#     print("lero")
#     child = CollaborationSerializer()
#     allow_null = True
#     many = True
...
#         like.article = Collaboration.objects.get(id=data["article"])
#         like.save()
#         return like
...
#         rating.article = Collaboration.objects.get(id=data["articleID"])
#         rating.save()
#         return rating
...
#         comment.article = Collaboration.objects.get(id=data["articleID"])
#         comment.save()
#         if("reply_to" in data):
...
# class CollaborationFeatureSerializer(serializers.ModelSerializer):
#     print("lero")
#     class Meta:
#         model = Collaboration
#         fields = ("__all__")
