...
import { Menu, Icon, Tabs, List, Row, Col } from 'antd';
import { connect } from 'react-redux';
import { Link, withRouter } from "react-router-dom";
import "../assets/projectTab.css"
import "../assets/projectTab2.scss"
...
function Aside({data}){
  ...
  return <CurrentScrolledSection sectionsWrapperRef={sectionsWrapperRef}>
    ...
    <aside 
      ...
      see={console.log("CORSO3: ", currentSection)}
      >
      <nav onMouseDown={onDragMouseDown}>
        {data.map(item => (
          <button
            ...
            see={console.log("CORSO4: ", currentSection === item.name)}
