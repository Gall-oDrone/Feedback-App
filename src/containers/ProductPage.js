    ...
    return (
      <div id="product-page">
          <div className="top-banner-container" id="product">
            ...
            {/* <section className="eight-section" id="languagesBannerId">
                  ...
                  <div className="_1TBpQomryh4JlZLsDwgQhi">
                    ...
                    <div className="_3H-7Qe8fS74lhxCAFfSk73">
                      <div className="_3QBwXTWg8lgAS38IsfnHj9">
                        <h2 className="_1iY1U-UeTX5NTWGxWKzOs-">We Speak 9 Languages.</h2>
                        <p className="_2-asERec5My6C4znmtLvOl">There's nothing more frustrating than opening an interview prep book, only to find a bunch of solutions in a programming language that you don't know. That's why all of our questions come with complete written solutions in 9 popular languages.</p>
