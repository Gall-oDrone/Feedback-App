  ...
  render(){
    ...
    return(
        <div className="row">
            ...
            <div className="rect">
                <img className="workshop-poster" ref="imgFile" src={selectedFile} alt={selectedFile}/>
                <i className="fa fa-user fa-5x"></i>
            </div>
            <div className="p-w-image">
                {/* <i className="fa fa-camera upload-button"></i> */}
                <Icon 
                    onClick={(e) => {this.handleProfilePic(e)}}
                    onChange={(e) => {this.handleChangePic(e)}}
                    type="plus" className="wsh-fa-add wsh-upload-button"></Icon>
