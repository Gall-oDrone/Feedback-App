...
import {getProfileSessionDetail, putProfileSessionDetail} from "../store/actions/profileSession";
...
class ProfileSessionDetail extends React.Component {
  ...
  render() {
    ...
    return (
      ...
      <Form {...formItemLayout} onSubmit={event => this.handleFormSubmit(
        ...
        <Form.Item label="Session Title" hasFeedback>
...
const WrappedRegistrationForm = Form.create()(ProfileSessionDetail);
...
const mapDispatchToProps = dispatch => {
  ...
  return {
    getPAD: (token, articleID, userID) => dispatch(getProfileSessionDetail(token, articleID, userID)),
    putPAD: (token, articleID, username, data) => dispatch(putProfileSessionDetail(token, articleID, username, data)),
  };
};
