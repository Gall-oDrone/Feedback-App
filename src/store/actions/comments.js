...
export const getComment = (token, articleID) => {
    return dispatch => {
      console.log(" getComment: ")
        ...
        axios.get(`http://127.0.0.1:8000/articles/${articleID}/comments/`)
        .then(res => {
            const data = res.data;
...
export const createComment = (token, data) => {
    return dispatch => {
        ...
        axios.post(`http://127.0.0.1:8000/articles/${data.articleID}/create-comment/`, data)
        .then(res => {
...
export const updateComment = (token, data) => {
    return dispatch => {
        ...
        axios.put(`http://127.0.0.1:8000/articles/${data.articleID}/update-comment/${data.id}/`, data)
        .then(res => {
