...
from walletApi.views import WalletCreateView, WalletUserListView, WalletTransactionListView, WalletBalanceView
...
urlpatterns = [
    ...
    path('userlist/<username>', WalletUserListView.as_view()),
    path('transactions/<wallet>/<username>', WalletTransactionListView.as_view()),
    path('balance/<username>', WalletBalanceView.as_view()),
    # path('transaction/<wallet>/<username>', WalletTransactionView.as_view()),
    # path('<pk>/delete/', WalletDeleteView.as_view()),
